...
namespace Back_end_BD.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Matricula,Nombre,Apellidos,Correo,Edad")] Profesores profesores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Matricula,Nombre,Apellidos,Correo,Edad")] Profesores profesores)
        {
            if (ModelState.IsValid)
            {
